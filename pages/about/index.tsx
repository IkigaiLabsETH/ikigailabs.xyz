    ...
    <main className="max-w-screen-2xl w-full">
      <div className="flex relative flex-col text-lg my-48 max-w-3xl mx-auto p-8">
        ...
        <div className='bg-black p-8 mt-8 mb-16 boska md:-translate-x-40'>
          <div className='text-[3.5rem] text-white font-bold p-4 mb-2'>Ikigai Labs XYZ</div>
          <div className='p-4 pl-20 text-white font-bold text-[2rem] leading-10'>The quintessential destination for exquisite digital artifacts.</div>
        </div>
        
        <Image src="/assets/images/about-1.png" alt="Ikigai Labs - Create" width={1920} height={1080} className="border-black border-4 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]"/>
        ...
        <Image src="/assets/images/about-2.png" alt="Ikigai Labs - Curate" width={1920} height={1080}  className="border-black border-4 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]"/>
        ...
        <Image src="/assets/images/about-3.png" alt="Ikigai Labs - Collect" width={1920} height={1080}  className="border-black border-4 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]"/> 
        ...
        <Image src="/assets/images/about-4.png" alt="Ikigai Labs - Vision" width={1920} height={1080}  className="border-black border-4 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]"/> 
