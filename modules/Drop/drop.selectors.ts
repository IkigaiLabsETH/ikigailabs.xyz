...
export const selectMetadataById = (contract: string) => (state: RootState) => metadataSelectors.selectById(state, contract)
...
export const selectClaimedSupplyById = (contract: string) => (state: RootState) => claimedSupplySelectors.selectById(state, contract)
...
export const selectUnclaimedSupplyById = (contract: string) => (state: RootState) => unclaimedSupplySelectors.selectById(state, contract)
...
export const selectClaimsForAddress = (address: string) => pipe(pathOr([], ['claims', 'entities']), filter(propEq('address', address)))
export const selectLatestClaimForAddress = (address: string) => pipe(pathOr([], ['claims', 'entities']), filter(propEq('address', address)), last)
