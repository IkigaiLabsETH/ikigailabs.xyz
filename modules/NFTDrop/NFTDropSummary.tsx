...
export const NFTDropSummary: FC<NFTDropSummaryProps> = ({ address, metadata: { name, description, image } }) => (
  <div className="flex relative flex-col lg:flex-row-reverse w-screen lg:h-screen items-center">
    <div
      className="w-full lg:w-1/2 h-96 lg:h-screen bg-no-repeat bg-center bg-contain lg:bg-cover"
