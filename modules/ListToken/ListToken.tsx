      ...
      <div className="flex flex-row">
        ...
        <div className="w-full md:w-1/2 bg-gray-100 h-full">
          <div className="p-4 lg:p-8">
            ...
            <div className="mb-6">
              <div className="text-lg font-bold mb-2">Where would you like to list?</div>
              <div className="mt-6">
                <Toggle
                  label="Ikigai Labs"
                  description="List your item on the Ikigai Labs marketplace "
                  disabled={true}
                  initialState={true}
                ...
                <Toggle
                  label="Open Sea"
                  description="List your item on the Open Sea marketplace"
                  initialState={false}
            ...
            {tokenInteractionStatus === 'failed' && (
              <p className="text-red mt-5 flex w-full justify-center font-bold">Failed to list for sale</p>
            )}
          </div>
        </div>
      </div>
