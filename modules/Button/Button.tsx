...
export const Button: FC<ButtonProps> = ({ label, onClick }) => (
  <a
    href="#"
    title={label}
    className="font-extrabold uppercase tracking-tighter border-2 border-yellow shadow-[5px_5px_0px_0px_rgba(255,255,255,1)] group h-[44px] overflow-clip whitespace-nowrap"
    role="button"
    onClick={e => onClick(e)}
  >
